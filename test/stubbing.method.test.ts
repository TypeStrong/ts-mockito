...
describe("mocking", () => {
    ...
    describe("calling method", () => {
        ...
        describe("with stubbed promise resolve", () => {
            it("resolves with given value", (t, done) => {
                // given
            ...
            it("resolves with multiple values", (t, done) => {
            ...
            it("resolves void promise", (t, done) => {
            ...
            it("resolves void promise without arguments", (t, done) => {
        ...
        describe("with stubbed promise rejection", () => {
            it("rejects with given error", (t, done) => {
                // given
                const sampleValue = "abc";
                const sampleError = new Error("sampleError");
                ...
                // when
                foo.sampleMethodReturningPromise(sampleValue)
                    .then(value => done(new Error("Expected promise to reject")))
                    .catch(err => {
                        // then
            ...
            describe("But without defined error", () => {
                it("rejects with default error", (t, done) => {
                    // given
