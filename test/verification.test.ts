...
cases.forEach(testData => {
    describe(testData.desc, () => {
            ...
            describe("and no one occurred", () => {
                it("doesn't throw error", () => {
                    ...
                    try {
                        ...
                        assert.fail("Expected method to be called just once");
                    }
                });
            });
            ...
            describe("and just two occurred", () => {
                it("doesn't throw error", () => {
                    ...
                    try {
                        ...
                        assert.fail("Expected method to be called twice");
                    }
                });
            });
            ...
            describe("and just three occurred", () => {
                it("doesn't throw error", () => {
                    ...
                    try {
                        ...
                        assert.fail("Expected method to be called thrice");
                    }
                });
            });
            ...
            describe("but three has occurred", () => {
                it("doesn't throw error", () => {
                    ...
                    try {
                        ...
                        assert.fail("Expected method to be called at least two times");
                    }
                });
            });
            ...
            describe("but one has occurred", () => {
                it("doesn't throw error", () => {
                    ...
                    try {
                        ...
                        assert.fail("Expected method to be called at most two times");
                    }
                });
            });
        ...
        describe("matcher error messages", () => {
            ...
            it("should describe expected method call with a null argument", () => {
                instance(mockedFoo).getStringById(null as any);
                ...
                try {
                    ...
                    expect(e.message).toContain("Expected \"getStringById(strictEqual(1))\" to be called 1 time(s). But has been called 0 time(s).\n");
                    expect(e.message).toContain("Actual calls:\n");
                    expect(e.message).toContain("getStringById(null)");
                }
            });

            it("should describe expected method call with an undefined argument", () => {
                instance(mockedFoo).getStringById(undefined as any);
